const PizzaContainerModule = (function () {
  ...
  let pizzaContainer = [
    ...
    {
      img: "images/menu/Pizza/kebabpizza.jpg",
    ...
    {
      img: "images/menu/Pizza/svensken.jpg",
      name: "Svensken",
    ...
    {
      img: "images/menu/Pizza/donjuan.jpg",
      name: "Don Juan",
    ...
    {
      img: "images/menu/Pizza/viking.jpg",
      name: "Viking",
    ...
    {
      img: "images/menu/Pizza/nomeat.jpg",
      name: "Hawaii",
    ...
    {
      img: "images/menu/Pizza/tacospesial.jpg",
      name: "Tacospesial",
    ...
    {
      img: "images/menu/Pizza/fourcheese.jpg",
      name: "Vegetariano",
