                    ...
                    <div id="contact-map-div">
                        <div class="mapouter">
                            <div class="gmap_canvas">
                                <iframe title="iframe3" width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=louises%20gate%2017c&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
